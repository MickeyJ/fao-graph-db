...
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_element_codes
ON fao_graph."TRADES" USING btree ((properties->>'element_codes'));
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_element
ON fao_graph."TRADES" USING btree ((properties->>'element'));
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_element_code
ON fao_graph."TRADES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_elements
ON fao_graph."TRADES" USING btree ((properties->>'elements'));
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_flow_direction
...
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_compound
ON fao_graph."TRADES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_trade_indices_trades_source
