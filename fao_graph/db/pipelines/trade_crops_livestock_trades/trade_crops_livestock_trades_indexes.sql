...
CREATE INDEX IF NOT EXISTS idx_trade_crops_livestock_trades_element_codes
...
CREATE INDEX IF NOT EXISTS idx_trade_crops_livestock_trades_elements
ON fao_graph."TRADES" USING btree ((properties->>'elements'));
CREATE INDEX IF NOT EXISTS idx_trade_crops_livestock_trades_flow_direction
