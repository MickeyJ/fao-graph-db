# Generated graph migrator for partner_country_codes
...
class PartnerCountryCodeMigrator(GraphMigrationBase):
    """Migrator for partner_country_codes node"""
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        """Execute the migration for partner_country_codes"""
        logger.info(f"Starting partner_country_codes migration...")
        ...
        try:
            ...
            logger.warning(f"\npartner_country_codes migration interrupted")
            raise
        except Exception as e:
            logger.error(f"Failed to migrate partner_country_codes: {e}")
            raise MigrationError(f"partner_country_codes migration failed: {e}") from e
