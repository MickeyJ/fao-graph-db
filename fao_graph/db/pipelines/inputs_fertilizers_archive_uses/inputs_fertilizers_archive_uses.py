...
# Generated relationship migrator for inputs_fertilizers_archive USES relationships
...
class InputsFertilizersArchiveUsesMigrator(GraphMigrationBase):
    """Migrator for inputs_fertilizers_archive USES relationships"""
    ...
    def get_index_queries(self) -> str:
        return load_sql("inputs_fertilizers_archive_uses_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("inputs_fertilizers_archive_uses_verify.cypher.sql", Path(__file__).parent)
