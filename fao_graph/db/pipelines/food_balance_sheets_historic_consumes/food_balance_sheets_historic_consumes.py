...
# Generated relationship migrator for food_balance_sheets_historic CONSUMES relationships
...
class FoodBalanceSheetsHistoricConsumesMigrator(GraphMigrationBase):
    """Migrator for food_balance_sheets_historic CONSUMES relationships"""
    ...
    def get_index_queries(self) -> str:
        return load_sql("food_balance_sheets_historic_consumes_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("food_balance_sheets_historic_consumes_verify.cypher.sql", Path(__file__).parent)
    
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        """Execute the migration for food_balance_sheets_historic CONSUMES relationships"""
        logger.info(f"Starting food_balance_sheets_historic CONSUMES relationship migration...")
        ...
        try:
            ...
            with get_session() as session:
                ...
                logger.info(f"Created {self.created} CONSUMES relationships from food_balance_sheets_historic")
