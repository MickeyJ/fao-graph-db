...
# Generated relationship migrator for food_balance_sheets_historic TRADES relationships
...
class FoodBalanceSheetsHistoricTradesMigrator(GraphMigrationBase):
    """Migrator for food_balance_sheets_historic TRADES relationships"""
    ...
    def __init__(self):
        ...
        self.relationship_properties = {"element": "Import Quantity", "element_code": "5611", "element_codes": ["5611", "5911"], "elements": true, "flow_direction": "bidirectional"}
    
    def get_migration_query(self) -> str:
        return load_sql("food_balance_sheets_historic_trades.cypher.sql", Path(__file__).parent)
    
    def get_index_queries(self) -> str:
        return load_sql("food_balance_sheets_historic_trades_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("food_balance_sheets_historic_trades_verify.cypher.sql", Path(__file__).parent)
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        ...
        logger.info(f"  Relationship type properties: {'element_codes': ['5611', '5911'], 'element': 'Import Quantity', 'element_code': '5611', 'elements': True, 'flow_direction': 'bidirectional'}")
