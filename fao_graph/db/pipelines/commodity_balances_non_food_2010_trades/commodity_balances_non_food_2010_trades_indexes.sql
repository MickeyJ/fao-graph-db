-- Indexes for TRADES relationships from commodity_balances_non_food_2010

-- Index on relationship properties
CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_element_codes
ON fao_graph."TRADES" USING btree ((properties->>'element_codes'));
CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_element
...
CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_year
ON fao_graph."TRADES" USING btree ((properties->>'year'));


CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_value
ON fao_graph."TRADES" USING btree ((properties->>'value'));

-- Compound index for common query patterns
CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_compound
ON fao_graph."TRADES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_commodity_balances_non_food_2010_trades_source
