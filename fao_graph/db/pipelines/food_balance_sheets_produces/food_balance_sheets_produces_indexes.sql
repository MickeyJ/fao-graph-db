...
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_element_codes
ON fao_graph."PRODUCES" USING btree ((properties->>'element_codes'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_element
ON fao_graph."PRODUCES" USING btree ((properties->>'element'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_element_code
ON fao_graph."PRODUCES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_elements
...
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_compound
ON fao_graph."PRODUCES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_produces_source
