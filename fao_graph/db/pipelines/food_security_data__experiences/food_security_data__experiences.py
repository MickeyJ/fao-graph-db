...
# Generated migrator for relationship food_security_data__experiences
import json
...
class FoodSecurityDataExperiencesMigrator(GraphMigrationBase):
    """Migrator for EXPERIENCES relationships from food_security_data"""
    ...
    def get_migration_query(self) -> str:
        return load_sql("food_security_data__experiences.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("food_security_data__experiences_verify.cypher.sql", Path(__file__).parent)

    def get_total_rows_query(self) -> str:
        """Count records matching our filters"""
        return load_sql("food_security_data__experiences_total_rows.sql", Path(__file__).parent)
