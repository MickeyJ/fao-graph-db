...
class ForestryProducesMigrator(GraphMigrationBase):
    ...
    def __init__(self):
        ...
        self.relationship_properties = {"element": "Production", "element_code": "5510", "element_codes": ["5510", "5516"], "elements": true}
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        ...
        logger.info(f"  Relationship type properties: {'element_codes': ['5510', '5516'], 'element': 'Production', 'element_code': '5510', 'elements': True}")
