-- Indexes for EMPLOYS relationships from employment_indicators_agriculture

-- Index on relationship properties
CREATE INDEX IF NOT EXISTS idx_employment_indicators_agriculture_employs_indicator_codes
ON fao_graph."EMPLOYS" USING btree ((properties->>'indicator_codes'));
CREATE INDEX IF NOT EXISTS idx_employment_indicators_agriculture_employs_indicator
...
CREATE INDEX IF NOT EXISTS idx_employment_indicators_agriculture_employs_value
ON fao_graph."EMPLOYS" USING btree ((properties->>'value'));

-- Compound index for common query patterns
CREATE INDEX IF NOT EXISTS idx_employment_indicators_agriculture_employs_compound
ON fao_graph."EMPLOYS" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_employment_indicators_agriculture_employs_source
