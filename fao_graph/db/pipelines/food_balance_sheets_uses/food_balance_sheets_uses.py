...
# Generated relationship migrator for food_balance_sheets USES relationships
...
class FoodBalanceSheetsUsesMigrator(GraphMigrationBase):
    """Migrator for food_balance_sheets USES relationships"""
    ...
    def get_index_queries(self) -> str:
        return load_sql("food_balance_sheets_uses_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("food_balance_sheets_uses_verify.cypher.sql", Path(__file__).parent)
