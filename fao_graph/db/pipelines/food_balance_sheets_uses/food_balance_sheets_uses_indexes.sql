...
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_resource
ON fao_graph."USES" USING btree ((properties->>'resource'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_purpose
ON fao_graph."USES" USING btree ((properties->>'purpose'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_element_code
ON fao_graph."USES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_element
...
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_compound
ON fao_graph."USES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_food_balance_sheets_uses_source
