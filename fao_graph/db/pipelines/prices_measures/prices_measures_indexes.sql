...
CREATE INDEX IF NOT EXISTS idx_prices_measures_category
ON fao_graph."MEASURES" USING btree ((properties->>'category'));
CREATE INDEX IF NOT EXISTS idx_prices_measures_price_type
ON fao_graph."MEASURES" USING btree ((properties->>'price_type'));
CREATE INDEX IF NOT EXISTS idx_prices_measures_currency
ON fao_graph."MEASURES" USING btree ((properties->>'currency'));
CREATE INDEX IF NOT EXISTS idx_prices_measures_element_code
ON fao_graph."MEASURES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_prices_measures_element
...
CREATE INDEX IF NOT EXISTS idx_prices_measures_compound
ON fao_graph."MEASURES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_prices_measures_source
