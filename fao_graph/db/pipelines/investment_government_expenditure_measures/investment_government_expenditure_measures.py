...
# Generated relationship migrator for investment_government_expenditure MEASURES relationships
...
class InvestmentGovernmentExpenditureMeasuresMigrator(GraphMigrationBase):
    """Migrator for investment_government_expenditure MEASURES relationships"""
    ...
    def get_index_queries(self) -> str:
        return load_sql("investment_government_expenditure_measures_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("investment_government_expenditure_measures_verify.cypher.sql", Path(__file__).parent)
