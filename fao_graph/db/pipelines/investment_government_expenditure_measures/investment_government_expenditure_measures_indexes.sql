...
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_category
ON fao_graph."MEASURES" USING btree ((properties->>'category'));
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_flow_type
ON fao_graph."MEASURES" USING btree ((properties->>'flow_type'));
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_element_code
ON fao_graph."MEASURES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_element
...
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_compound
ON fao_graph."MEASURES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_investment_government_expenditure_measures_source
