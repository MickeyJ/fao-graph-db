...
class PurposeMigrator(GraphMigrationBase):
    ...
    def get_migration_query(self) -> str:
        return load_sql("purpose.cypher.sql", Path(__file__).parent)
    
    def get_index_queries(self) -> str:
        return load_sql("purpose_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
      return load_sql("purpose_verify.cypher.sql", Path(__file__).parent)
