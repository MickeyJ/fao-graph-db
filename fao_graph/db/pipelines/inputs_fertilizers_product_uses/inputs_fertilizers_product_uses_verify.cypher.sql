...
SELECT count(*) FROM cypher('fao_graph', $$
    MATCH ()-[r:USES]->()
    WHERE r.source_dataset = 'inputs_fertilizers_product'
    RETURN count(r)
$$) as (count agtype);
...
, resource agtype, measure agtype, element_code agtype, element agtype, year agtype, value agtype, unit agtype);