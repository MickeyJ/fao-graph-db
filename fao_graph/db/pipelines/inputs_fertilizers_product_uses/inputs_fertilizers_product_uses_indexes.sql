...
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_resource
ON fao_graph."USES" USING btree ((properties->>'resource'));
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_measure
ON fao_graph."USES" USING btree ((properties->>'measure'));
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_element_code
ON fao_graph."USES" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_element
...
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_compound
ON fao_graph."USES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_inputs_fertilizers_product_uses_source
