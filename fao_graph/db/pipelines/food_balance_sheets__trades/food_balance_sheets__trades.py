...
class FoodBalanceSheetsTradesMigrator(GraphMigrationBase):
    ...
    def get_total_rows_query(self) -> str:
        ...
        return load_sql("food_balance_sheets__trades_total_rows.sql", Path(__file__).parent)
    ...
    def create(self, records, session):
        ...
        for record in records:
            ...
            if self.created % 500 == 0:
                logger.info(f"food_balance_sheets - (area_code_id: {source_id})-[:TRADES]->(item_code_id: {target_id})")
