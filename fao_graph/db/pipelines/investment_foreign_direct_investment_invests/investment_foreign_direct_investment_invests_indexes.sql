...
CREATE INDEX IF NOT EXISTS idx_investment_foreign_direct_investment_invests_elements
...
CREATE INDEX IF NOT EXISTS idx_investment_foreign_direct_investment_invests_value
ON fao_graph."INVESTS" USING btree ((properties->>'value'));

-- Compound index for common query patterns
CREATE INDEX IF NOT EXISTS idx_investment_foreign_direct_investment_invests_compound
ON fao_graph."INVESTS" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_investment_foreign_direct_investment_invests_source
