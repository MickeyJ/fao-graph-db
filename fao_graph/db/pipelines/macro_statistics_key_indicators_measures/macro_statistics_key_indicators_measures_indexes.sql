...
CREATE INDEX IF NOT EXISTS idx_macro_statistics_key_indicators_measures_category
ON fao_graph."MEASURES" USING btree ((properties->>'category'));
CREATE INDEX IF NOT EXISTS idx_macro_statistics_key_indicators_measures_measure
