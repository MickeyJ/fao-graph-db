...
# Generated relationship migrator for investment_machinery TRADES relationships
...
class InvestmentMachineryTradesMigrator(GraphMigrationBase):
    """Migrator for investment_machinery TRADES relationships"""
    ...
    def get_migration_query(self) -> str:
        return load_sql("investment_machinery_trades.cypher.sql", Path(__file__).parent)
    
    def get_index_queries(self) -> str:
        return load_sql("investment_machinery_trades_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("investment_machinery_trades_verify.cypher.sql", Path(__file__).parent)
    
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        """Execute the migration for investment_machinery TRADES relationships"""
        logger.info(f"Starting investment_machinery TRADES relationship migration...")
        ...
        try:
            ...
            with get_session() as session:
                ...
                logger.info(f"Created {self.created} TRADES relationships from investment_machinery")
