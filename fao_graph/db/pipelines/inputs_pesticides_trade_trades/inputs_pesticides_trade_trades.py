...
class InputsPesticidesTradeTradesMigrator(GraphMigrationBase):
    ...
    def __init__(self):
        ...
        self.relationship_properties = {"element": "Import quantity", "element_code": "5610", "element_codes": ["5610", "5622", "5910", "5922"], "elements": true, "flow_direction": "bidirectional"}
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        ...
        logger.info(f"  Relationship type properties: {'element_codes': ['5610', '5622', '5910', '5922'], 'element': 'Import quantity', 'element_code': '5610', 'elements': True, 'flow_direction': 'bidirectional'}")
