...
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_element_codes
ON fao_graph."EMITS" USING btree ((properties->>'element_codes'));
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_element
ON fao_graph."EMITS" USING btree ((properties->>'element'));
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_element_code
ON fao_graph."EMITS" USING btree ((properties->>'element_code'));
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_elements
ON fao_graph."EMITS" USING btree ((properties->>'elements'));
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_gas_type
...
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_compound
ON fao_graph."EMITS" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_emissions_totals_emits_source
