-- Indexes for UTILIZES relationships from inputs_pesticides_use

-- Index on relationship properties
CREATE INDEX IF NOT EXISTS idx_inputs_pesticides_use_utilizes_element_codes
ON fao_graph."UTILIZES" USING btree ((properties->>'element_codes'));
CREATE INDEX IF NOT EXISTS idx_inputs_pesticides_use_utilizes_element
...
CREATE INDEX IF NOT EXISTS idx_inputs_pesticides_use_utilizes_value
ON fao_graph."UTILIZES" USING btree ((properties->>'value'));

-- Compound index for common query patterns
CREATE INDEX IF NOT EXISTS idx_inputs_pesticides_use_utilizes_compound
ON fao_graph."UTILIZES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_inputs_pesticides_use_utilizes_source
