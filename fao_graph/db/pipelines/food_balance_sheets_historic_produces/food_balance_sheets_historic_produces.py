...
# Generated relationship migrator for food_balance_sheets_historic PRODUCES relationships
...
class FoodBalanceSheetsHistoricProducesMigrator(GraphMigrationBase):
    """Migrator for food_balance_sheets_historic PRODUCES relationships"""
    ...
    def __init__(self):
        ...
        self.relationship_properties = {"element": "Production", "element_code": "5511", "element_codes": ["5511"], "elements": true}
    
    def get_migration_query(self) -> str:
        return load_sql("food_balance_sheets_historic_produces.cypher.sql", Path(__file__).parent)
    
    def get_index_queries(self) -> str:
        return load_sql("food_balance_sheets_historic_produces_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("food_balance_sheets_historic_produces_verify.cypher.sql", Path(__file__).parent)
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        ...
        logger.info(f"  Relationship type properties: {'element_codes': ['5511'], 'element': 'Production', 'element_code': '5511', 'elements': True}")
