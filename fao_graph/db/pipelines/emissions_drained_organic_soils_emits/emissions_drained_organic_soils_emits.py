...
class EmissionsDrainedOrganicSoilsEmitsMigrator(GraphMigrationBase):
    ...
    def __init__(self):
        ...
        self.element_codes = ['5026', '7230', '7273']
        self.elements = ['Area', 'Emissions (N2O)', 'Emissions (CO2)']
        self.relationship_properties = {"category": "general", "element": "Emissions (CO2)", "element_code": "7273", "gas_type": "CO2", "source": "organic_soils"}
    ...
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        ...
        logger.info(f"  Elements: Area, Emissions (N2O), Emissions (CO2)")
        logger.info(f"  Properties: {'source': 'organic_soils', 'gas_type': 'CO2', 'category': 'general', 'element_code': '7273', 'element': 'Emissions (CO2)'}")
