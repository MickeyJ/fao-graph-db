...
CREATE INDEX IF NOT EXISTS idx_investment_credit_agriculture_invests_measure
ON fao_graph."INVESTS" USING btree ((properties->>'measure'));
CREATE INDEX IF NOT EXISTS idx_investment_credit_agriculture_invests_currency
