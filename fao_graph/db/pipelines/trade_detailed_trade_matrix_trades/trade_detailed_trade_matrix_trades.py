...
# Generated relationship migrator for trade_detailed_trade_matrix TRADES relationships
...
class TradeDetailedTradeMatrixTradesMigrator(GraphMigrationBase):
    """Migrator for trade_detailed_trade_matrix TRADES relationships"""
    ...
    def get_migration_query(self) -> str:
        return load_sql("trade_detailed_trade_matrix_trades.cypher.sql", Path(__file__).parent)
    
    def get_index_queries(self) -> str:
        return load_sql("trade_detailed_trade_matrix_trades_indexes.sql", Path(__file__).parent)
    
    def get_verification_query(self) -> str:
        return load_sql("trade_detailed_trade_matrix_trades_verify.cypher.sql", Path(__file__).parent)
    
    def migrate(self, start_offset: int = 0, mode: str = "create") -> None:
        """Execute the migration for trade_detailed_trade_matrix TRADES relationships"""
        logger.info(f"Starting trade_detailed_trade_matrix TRADES relationship migration...")
