...
CREATE INDEX IF NOT EXISTS idx_production_indices_produces_elements
...
CREATE INDEX IF NOT EXISTS idx_production_indices_produces_compound
ON fao_graph."PRODUCES" USING GIN (properties);

-- Source dataset index for filtering
CREATE INDEX IF NOT EXISTS idx_production_indices_produces_source
